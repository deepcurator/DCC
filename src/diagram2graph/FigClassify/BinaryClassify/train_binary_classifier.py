...
# Command: python diagram_binary_classify.py --model vgg16

# Construct the argument parse and parse the arguments
ap = argparse.ArgumentParser()
ap.add_argument("-model", "--model", type=str, default="vgg16",
	help="name of pre-trained network to use")
ap.add_argument('-i', '--datasetdir', required=True, help='Path to dir containing "DATASET_Binary_V1.0"')
...
trainingFeature_path = os.path.join(feature_dir_path, args["model"]+'_train_features.h5')
trainingLabel_path = os.path.join(feature_dir_path, args["model"]+'_train_labels.h5')
validationFeature_path = os.path.join(feature_dir_path, args["model"]+'_validation_features.h5')
validationLabel_path = os.path.join(feature_dir_path, args["model"]+'_validation_labels.h5')
...
trainfeatures_string = h5f_traindata[args["model"]+'_train_features']
trainlabels_string   = h5f_trainlabel[args["model"]+'_train_labels']
...
validationfeatures_string = h5f_validationdata[args["model"]+'_validation_features']
validationlabels_string   = h5f_validationlabel[args["model"]+'_validation_labels']
