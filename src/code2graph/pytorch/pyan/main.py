...
def main():
    ...
    parser.add_option("--arg",
                      action="store_true", default=True, dest="draw_arguments",
                      help="add edges for 'argument' relationships")
    parser.add_option("--dval",
                      action="store_true", default=True, dest="draw_default_values",
                      help="add edges for 'default values of arguments' relationships")
    ...
    graph_options = {
            ...
            'draw_arguments': options.draw_arguments,
            'draw_default_values': options.draw_default_values,
