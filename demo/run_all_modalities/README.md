...
### Grobid Client
Download [Grobid client](https://github.com/kermitt2/grobid-client-python) and extract it to the demo folder. The resulting folder structure will be: demo\grobid-client-python
